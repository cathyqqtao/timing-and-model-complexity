      seqfile = jarvis_10k_seq.phy 
     treefile = jarvis_tree_topo.txt
	 
      outfile = Jarvis_unrestricted.txt       * main result file
        noisy = 2   * 0,1,2,3: how much rubbish on the screen
      verbose = 0   * 1: detailed output, 0: concise output
      runmode = 0   * 0: user tree;  1: semi-automatic;  2: automatic
                    * 3: StepwiseAddition; (4,5):PerturbationNNI 

        model = 10 [11 (TA) (TG) (CT) (CA) (CG) (AT) (AC) (AG) (GT) (GC) (GA) ]   * 0:JC69, 1:K80, 2:F81, 3:F84, 4:HKY85

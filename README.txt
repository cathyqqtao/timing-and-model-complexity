...
The zip file consists of results of eight empirical datasets. Each data subfolder contains full alignment, subsampled alignment (if applicable), ML branch lengths phylogenies, and input files and timetrees inferred using Bayesian (MCMCTree) and RelTime methods with simple and complex substitution models.
